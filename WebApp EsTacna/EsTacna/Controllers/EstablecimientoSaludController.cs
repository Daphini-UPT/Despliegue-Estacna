...
namespace EsTacna.Controllers
{
    public class EstablecimientoSaludController : Controller
    {
        ...
        {
            EstablecimientoSaludViewModel objEstablecimientoVm = new EstablecimientoSaludViewModel();
            var establecimientoId = objEstablecimientoRepo.BuscarId(EstablecimientoId);
            objEstablecimientoVm.establecimientoSalud = establecimientoId;
            objEstablecimientoVm.eps = objEpsEstablecimientoRepo.BuscarIdEps(EstablecimientoId);
            objEstablecimientoVm.listValoracion = objValoracionRepo.ListarPorEstablecimientoId(establecimientoId.Id);
        ...
        public IActionResult Valorar(Valoracion objValoracion)
        {
            ...
            return RedirectToAction("Detalle", new { establecimientoId = objValoracion.EstablecimientoId });
        }
